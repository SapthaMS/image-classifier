...
image_dir=r"C:\Users\SAPTHA\Desktop\image classifier\Dataset_Celebrities\cropped"
...
plt.savefig(r'C:\Users\SAPTHA\Desktop\image classifier\Result\accuracy plot')
...
plt.savefig(r'C:\Users\SAPTHA\Desktop\image classifier\Result\loss plot')
...
submission.to_csv("C:/Users/SAPTHA/Desktop/image classifier/Result/Image_CNN.csv",index=False) 
print("--------------------------------------\n")